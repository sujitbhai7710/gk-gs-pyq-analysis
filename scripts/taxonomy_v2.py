...
HISTORY_SUBTOPICS = {
    "Prehistoric Period & Indus Valley Civilization": [
        ...
        "bronze age", "stone age", "rock painting", "burial", "mesolithic", "microlith"
    ],
    ...
    "Early Medieval India & Rajput Period": [
        ...
        "jayachandra", "jaichand", "chittorgarh", "fort", "water bodies"
    ],
    "Delhi Sultanate": [
    ...
    "Mughal Empire": [
        ...
        "akbarnama", "badshahnama", "fatehpur sikri",
    ...
    "Socio-Religious Reform Movements": [
        ...
        "jotiba", "jyotiba phule", "narayana guru"
    ],
...
GEOGRAPHY_SUBTOPICS = {
    "Physical Geography (Geomorphology)": [
        ...
        "weathering", "erosion", "mass wasting", "glacial", "glacier",
        "landform", "mountain", "fold mountain", "block mountain",
        "plateau", "plain", "valley", "canyon", "gorge", "till", "drift"
    ],
    ...
    "Indian Minerals, Energy & Industries": [
        ...
        "navratna", "maharatna", "miniratna", "disinvestment",
        "psu", "public sector"
    ],
...
# ============== POLITY (with new criminal laws sub-topic) ==============
POLITY_SUBTOPICS = {
    ...
    "New Criminal Laws (BNS, BNSS, BSA)": [
        ...
        "video-recording", "search and seizure",
        "section 105", "section 62", "video-recorded confessions",
        "presumption of guilt", "substantive law", "civil procedure"
    ]
}
...
ECONOMICS_SUBTOPICS = {
    "Basics of Indian Economy": [
        ...
        "public sector", "private sector", "reform enabled mncs"
    ],
...
SCIENCE_SUBTOPICS = {
    ...
    "Chemistry - Chemical Bonding & Reactions": [
        ...
        "neutralization", "cooking utensils", "copper bottom"
    ],
...
# ============== STATIC GK - SPLIT into granular topics ==============
STATIC_GK_SUBTOPICS = {
    "Books & Authors": [
    ...
    "Indian Classical Dance Forms": [
        # Only classical dances - NOT folk, NOT music
        "bharatanatyam", "kathak", "kathakali", "manipuri",
        "odissi", "mohiniyattam", "sattriya", "kuchipudi",
        "classical dance", "natya shastra", "nritta", "nritya", "natya",
        "mudra", "abhinaya", "rasa"
    ],
    "Indian Folk Dances & Martial Arts": [
        # Folk dances and martial arts - separate from classical
    ...
    "Indian Music (Hindustani & Carnatic)": [
        # Only music theory, ragas, talas - NOT instruments, NOT dance
        "hindustani music", "carnatic music", "raga", "tala",
        "dhrupad", "khyal", "thumri", "bhajan", "qawwali",
        "gharana", "laghu", "drutam", "jaati",
        "bandish", "kriti", "varnam", "tillana", "alapana",
        "tishra", "chaturashra", "khanda", "mishra", "sankirna",
        "rhythmic cycle", "beats", "guru bin", "gun gaaye"
    ],
    "Indian Musical Instruments": [
        # Separate from music theory
        "tabla", "sitar", "veena", "sarod", "sarangi", "flute",
        "shehnai", "mridangam", "ghatam", "kartal", "manjira",
        "instrument", "burrakatha instrument",
        "primary instrument", "percussion", "string instrument"
    ],
    "Temple Architecture & Sculpture": [
        # Hindu/Buddhist/Jain temple architecture
        ...
        "mukha", "ardha", "maha",
        "chittorgarh", "chittor", "fort", "water bodies",
        "purana qila", "double-storeyed", "gate"
    ],
    "Indo-Islamic Architecture": [
        # Mughal, Sultanate, mosque, tomb architecture
        "mosque", "masjid", "dargah", "tomb", "mazar",
        "qutb minar", "alai darwaza", "iron pillar",
        "taj mahal", "red fort", "jama masjid", "buland darwaza",
        "fatehpur sikri", "agni", "charbagh",
        "indo-islamic", "mughal architecture", "sultanate architecture",
        "pietra dura", "jalika", "jali", "screen",
        "iwan", "pishtaq", "chhajja", "jharokha",
        "capuchin church", "church", "cathedral"
    ],
    "Modern Architecture & Monuments": [
        # Modern buildings, forts (non-temple), monuments
        "modern architecture", "monument",
        "india gate", "rashtrapati bhavan", "parliament house",
        "lotus temple", "akshardham",
        "victoria memorial", "gateway of india",
    ...
    "Science & Technology Current Developments": [
        ...
        "3d printing", "drone", "generative design",
        "aerospace systems engineering"
    ]
}

# ============== CURRENT AFFAIRS (unchanged) ==============
CURRENT_AFFAIRS_SUBTOPICS = {
    "National Affairs & Government Schemes": [
        ...
        "educational event", "key outcome", "initiative"
    ],
    ...
    "Sports Current Affairs": [
        ...
        "world cup", "ipl", "ashes",
        "intercontinental cup", "2023", "2024 final"
    ],
...
if __name__ == "__main__":
    print("REFINED TAXONOMY v2")
    print("=" * 60)
    total = 0
    for subj, subs in TAXONOMY.items():
        print(f"\n{subj}: {len(subs)} sub-topics")
